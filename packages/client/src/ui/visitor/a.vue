	...
	<div class="main">
		<div ref="contents" class="contents" :class="{ wallpaper }">
			...
			<div class="powered-by">
				<b><MkA to="/">{{ host }}</MkA></b>
				<small>Powered by <a href="https://git.aozora.uk/aozora-uk/azpick" target="_blank"><span style="color: var(--cherry);">Cherry</span><span style="color: var(--pick);">Pick</span></a></small>
			</div>
		</div>
	</div>
</div>
