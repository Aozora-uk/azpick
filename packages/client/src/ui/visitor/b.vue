...
<div class="mk-app">
	...
	<div class="main">
		...
		<div class="contents">
			...
			<div v-if="!root" class="powered-by">
				<b><MkA to="/">{{ host }}</MkA></b>
				<small>Powered by <a href="https://github.com/aozora-uk/azpick" target="_blank"><span style="color: var(--cherry);">AZ</span><span style="color: var(--pick);">Pick</span></a></small>
			</div>
		</div>
	</div>
	...
	<transition :name="$store.state.animation ? 'tray' : ''">
		<div v-if="showMenu" class="menu">
			...
			<MkA to="/announcements" class="link" active-class="active"><i class="fas fa-broadcast-tower"></i>{{ $ts.announcements }}</MkA>
