				...
				<FormSection>
					...
					<div :class="$style.contributors">
						...
						<a href="https://github.com/r-ca" target="_blank" :class="$style.contributor">
							...
							<span :class="$style.contributorUsername">@r-ca(rca-fedi/cherrypick)</span>
						</a>
