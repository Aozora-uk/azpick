...
describe('users/notes', () => {
	...
	before(async () => {
		...
		const jpg = await uploadUrl(alice, 'https://raw.githubusercontent.com/atsu1125/misskey-v12/v12fix/packages/backend/test/resources/Lenna.jpg');
		const png = await uploadUrl(alice, 'https://raw.githubusercontent.com/atsu1125/misskey-v12/v12fix/packages/backend/test/resources/Lenna.png');
